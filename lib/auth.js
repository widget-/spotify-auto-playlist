...
/** Cache auth token to authToken.json */
...
/** Read cached auth token from authToken.json */
...
/**
 * Sets up an app auth request from Spotify.
 * 
 * Starts up a temporary server to handle the auth redirect.
 */
async function auth() {
